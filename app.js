...
// ========== フォーメーション（野球） ==========
// SVG座標基準: ホームy=102, 1塁(78,78), 2塁(50,54), 3塁(22,78), マウンド(50,72)
const PRESETS = {
  '標準守備': [
    { role: 'C',  x: 50, y: 113 }, // 捕手：ホームの後方
    { role: 'P',  x: 50, y: 72  }, // 投手：マウンド上
    { role: '1B', x: 77, y: 72  }, // 一塁手：1塁寄り・やや前
    { role: '2B', x: 65, y: 60  }, // 二塁手：1塁〜2塁間
    { role: '3B', x: 23, y: 72  }, // 三塁手：3塁寄り・やや前
    { role: 'SS', x: 35, y: 58  }, // 遊撃手：2塁〜3塁間
    { role: 'LF', x: 20, y: 28  }, // 左翼手
    { role: 'CF', x: 50, y: 14  }, // 中堅手
    { role: 'RF', x: 80, y: 28  }, // 右翼手
  ],
  'DH制': [
    { role: 'C',  x: 50, y: 113 },
    { role: 'P',  x: 50, y: 72  },
    ...
    { role: 'CF', x: 50, y: 14  },
    { role: 'RF', x: 80, y: 28  },
    { role: 'DH', x: 90, y: 96  }, // 指名打者：ファウルゾーン
  ],
  '内野シフト': [
    { role: 'C',  x: 50, y: 113 },
    { role: 'P',  x: 50, y: 72  },
    { role: '1B', x: 74, y: 68  }, // 一塁手：やや2塁寄り
    { role: '2B', x: 68, y: 60  }, // 二塁手：右寄りシフト
    { role: '3B', x: 57, y: 60  }, // 三塁手：2塁右に移動
    { role: 'SS', x: 63, y: 54  }, // 遊撃手：2塁の右側
    { role: 'LF', x: 20, y: 28  },
    { role: 'CF', x: 50, y: 14  },
    { role: 'RF', x: 80, y: 28  },
  ],
